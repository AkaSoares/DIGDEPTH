...
function Scratch() {
    ...
    if (sprite_index == s_p_RIGHT) {
        ...
        scratch_instance_below = instance_create_layer(spawn_x, spawn_y, layer_above, o_scratch_lefta);
        ...
        spawn_y -= offsety;
        rotation_angle = 90;
        scratch_instance_above = instance_create_layer(spawn_x, spawn_y, layer_below, o_scratch_UP);
